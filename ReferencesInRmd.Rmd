...
If we use the `bookdown`  package [@bookdown] then we can do references to tables, figures and sections.
...
Table \@ref(tab:tableKableExtra) shows something interesting with fomratting applied.
