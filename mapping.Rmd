...
\@ref(fig:sf.basic) shows two very basic sf-based maps. The first shows just boundaries, the second calculates a test value and applies a colour aesthetic to map it.

```{r sf.basic, fig.cap="Basic sf map of area unit boundaries for Dunedin, New Zealand"}
library(sf)
...
\@ref(fig:leaflet.basic) shows where R started :-)

```{r leaflet.basic, fig.cap="Basic leaflet plot showing the birthplace of R!"}
library(leaflet)
